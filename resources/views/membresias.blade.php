        ...
        <div class="col-md-4">
            <div class="card bg-dark text-white border-secondary shadow h-100 p-3">
                <div class="card-body d-flex flex-column">
                    ...
                    <form action="{{ route('carrito.agregar', 21) }}" method="POST" class="mt-auto w-100">
                        @csrf
        ...
        <div class="col-md-4">
            <div class="card bg-dark text-white border-warning shadow-lg h-100 p-3 position-relative">
                ...
                <div class="card-body d-flex flex-column mt-3">
                    ...
                    <form action="{{ route('carrito.agregar', 22) }}" method="POST" class="mt-auto w-100">
                        @csrf
        ...
        <div class="col-md-4">
            <div class="card bg-dark text-white border-info shadow h-100 p-3">
                <div class="card-body d-flex flex-column">
                    ...
                    <form action="{{ route('carrito.agregar', 23) }}" method="POST" class="mt-auto w-100">
                        @csrf
